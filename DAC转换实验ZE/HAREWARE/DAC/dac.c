...
void Dac1_Init(void)
{
	...
	RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOA, ENABLE );	  //使能PORTA通道时钟  是Clock，不是Reset
  RCC_APB1PeriphClockCmd(RCC_APB1Periph_DAC, ENABLE );	  //使能DAC通道时钟 
	...
	DAC_InitType.DAC_LFSRUnmask_TriangleAmplitude=DAC_LFSRUnmask_Bit0;    //屏蔽、幅形设置
	...
	DAC_Init(DAC_Channel_1,&DAC_InitType);            //根据参数初始化DAC通道
