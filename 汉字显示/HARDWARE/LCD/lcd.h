...
void Get_HzMat(unsigned char *code,u8* mat,u8 size);                      //从字库中查找出字模
void Show_Font(u16 x,u16 y,u8 *font,u8 size,u8 mode);               //显示一个指定大小的汉字
void Show_Str(u16 x,u16 y,u16 width,u16 height,u8*str,u8 size,u8 mode); //在指定位置开始显示一个字符串	   
