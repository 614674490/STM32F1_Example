...
u8 CAN_Mode_Init(u8 tsjw,u8 tbs2,u8 tbs1,u16 brp,u8 mode)
{
	...
	CAN_FilterInitStructure.CAN_FilterScale=CAN_FilterScale_32bit;      //位宽 32
	CAN_FilterInitStructure.CAN_FilterIdHigh=0x0000;                    //32为ID
	CAN_FilterInitStructure.CAN_FilterIdLow=0x0000;
	CAN_FilterInitStructure.CAN_FilterMaskIdHigh=0x0000;                //32位MASK
	CAN_FilterInitStructure.CAN_FilterMaskIdLow=0x0000;
	CAN_FilterInitStructure.CAN_FilterFIFOAssignment=CAN_Filter_FIFO0;  //分配到FIFO 0
	CAN_FilterInitStructure.CAN_FilterActivation=ENABLE;                //激活过滤器0 否则无法接收数据
